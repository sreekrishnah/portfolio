...
function Skills() {
    ...
    // Function to get screen width to change carousel settings.
        ...
        <section id="About" className='About-2'>
            ...
            <div className="skillset-container">
                <div className="title-card3">
                    <motion.h1 variants={boxVariant} initial='initial' whileInView='animate'>Skills & Experience</motion.h1>
                </div>
                <motion.h4 className='cyber-quote' variants={boxVariant} initial='initial' whileInView='animate'>
